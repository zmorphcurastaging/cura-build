if(CURA_BUILDTYPE STREQUAL "")
    cpack_add_component(_cura
                DISPLAY_NAME "Zmorph Voxelizer"
                Description "Zmorph Voxelizer Executable and Data Files"
                REQUIRED
    )
else()
    cpack_add_component(_cura
                DISPLAY_NAME "Zmorph Voxelizer ${CURA_BUILDTYPE}"
                Description "Zmorph Voxelizer ${CURA_BUILDTYPE} Executable and Data Files"
                REQUIRED
    )
endif()
...
if(CURA_BUILDTYPE STREQUAL "")
    set(CPACK_PACKAGE_NAME "Zmorph Voxelizer")
else()
    set(CPACK_PACKAGE_NAME "Zmorph Voxelizer ${CURA_BUILDTYPE}")
endif()
...
if(CURA_BUILDTYPE STREQUAL "")
    set(CPACK_PACKAGE_NAME "Zmorph Voxelizer ${CURA_FULL_VERSION}")
else()
    set(CPACK_PACKAGE_NAME "Zmorph Voxelizer ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
endif()
...
if(CURA_BUILDTYPE STREQUAL "")
    set(CPACK_CREATE_DESKTOP_LINKS Cura "Zmorph Voxelizer ${CURA_FULL_VERSION}")
    set(CPACK_PACKAGE_EXECUTABLES Cura "Zmorph Voxelizer ${CURA_FULL_VERSION}")
    set(CPACK_PACKAGE_INSTALL_DIRECTORY "Zmorph Voxelizer ${CURA_FULL_VERSION}")
else()
    set(CPACK_CREATE_DESKTOP_LINKS Cura "Zmorph Voxelizer ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
    set(CPACK_PACKAGE_EXECUTABLES Cura "Zmorph Voxelizer ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
    set(CPACK_PACKAGE_INSTALL_DIRECTORY "Zmorph Voxelizer ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
endif()
