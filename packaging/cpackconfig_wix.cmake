...
set(CPACK_WIX_PRODUCT_ICON "${CMAKE_SOURCE_DIR}/packaging/divid.ico")
set(CPACK_WIX_UI_BANNER "${CMAKE_SOURCE_DIR}/packaging/cura_banner_msi.bmp")
set(CPACK_WIX_UI_DIALOG "${CMAKE_SOURCE_DIR}/packaging/divid_background_msi.bmp")
if(CURA_BUILDTYPE STREQUAL "")
    set(CPACK_WIX_PROGRAM_MENU_FOLDER "Zmorph Divid")
else()
    set(CPACK_WIX_PROGRAM_MENU_FOLDER "Zmorph Divid ${CURA_BUILDTYPE}")
endif()
