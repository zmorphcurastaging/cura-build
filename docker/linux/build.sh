...
CURA_BRANCH_OR_TAG="${CURA_BRANCH_OR_TAG:-4.13}"
URANIUM_BRANCH_OR_TAG="${URANIUM_BRANCH_OR_TAG:-4.13}"
CURAENGINE_BRANCH_OR_TAG="${CURAENGINE_BRANCH_OR_TAG:-4.13}"
CURABINARYDATA_BRANCH_OR_TAG="${CURABINARYDATA_BRANCH_OR_TAG:-4.13}"
FDMMATERIALS_DATA_BRANCH_OR_TAG="${FDMMATERIALS_BRANCH_OR_TAG:-4.13}"
LIBCHARON_BRANCH_OR_TAG="${LIBCHARON_BRANCH_OR_TAG:-4.13}"
