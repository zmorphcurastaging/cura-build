...
CURA_BRANCH_OR_TAG="${CURA_BRANCH_OR_TAG:-4.13.0}"
URANIUM_BRANCH_OR_TAG="${URANIUM_BRANCH_OR_TAG:-4.13.0}"
CURAENGINE_BRANCH_OR_TAG="${CURAENGINE_BRANCH_OR_TAG:-4.13.0}"
CURABINARYDATA_BRANCH_OR_TAG="${CURABINARYDATA_BRANCH_OR_TAG:-4.13.0}"
FDMMATERIALS_DATA_BRANCH_OR_TAG="${FDMMATERIALS_BRANCH_OR_TAG:-4.13.0}"
LIBCHARON_BRANCH_OR_TAG="${LIBCHARON_BRANCH_OR_TAG:-4.13.0}"

CURA_VERSION_MAJOR="${CURA_VERSION_MAJOR:-4}"
CURA_VERSION_MINOR="${CURA_VERSION_MINOR:-13}"
